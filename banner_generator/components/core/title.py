...
class Component(BaseComponent):
    component_id = "title"
    z_index = 50
    section_name = None          # uses global title/ subtitle keys + [layout] section
    description = "Main title and subtitle (uses global title/subtitle and [layout] section)"
    config_schema = {}           # no component‑specific section; handled by GLOBAL_SCHEMA and LAYOUT_SCHEMA
