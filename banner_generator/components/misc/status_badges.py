...
class Component(BaseComponent):
    ...
    config_schema = {
        "badges": {"type": "list", "default": [], "help": "List of badge texts (overrides automatic tags)"},
        ...
        "pad": {"type": "int", "default": 8, "help": "Horizontal padding inside each badge"},
        "bg": {"type": "str", "default": "", "help": "Background color (overrides theme)"},
        "fg": {"type": "str", "default": "", "help": "Text color (overrides theme)"},
        "stroke": {"type": "str", "default": "", "help": "Border color"},
        "opacity": {"type": "float", "default": 0.7, "help": "Opacity of badge background"},
        "max_badges": {"type": "int", "default": 4, "help": "Maximum number of badges to show (if using automatic tags)"},
    }
