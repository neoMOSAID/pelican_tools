...
MODE_COLORS = {
    "NORMAL": ("normal", "#50fa7b"),
    "INSERT": ("insert", "#bd93f9"),
    "VISUAL": ("visual", "#8be9fd"),
    "COMMAND": ("command", "#ffb86c"),
    "REPLACE": ("replace", "#ff5555"),
}
...
class Component(BaseComponent):
    ...
    def render(self) -> str:
        ...
        if animated:
            cursor = (
                f'<rect x="{x + w - 24}" y="{y + 10}" width="8" height="16" fill="{self.col.get("vim_cursor", "#ffb86c")}">'
